...
export default function BilliePage() {
  ...
  .</p>
      ...
      <div className="billie-image-container">
        <img src='/images/Billie Eillish.jpg' alt="Billie Eilish Poster" className="billie-main-image" />
      </div>
      <p className="billie-description">While the original cover shows Billie <strong>falling from a floating door</strong>, this artwork places her <strong>fully submerged</strong>, looking up at 
  ...
  a <strong>tribute to Billie’s storytelling style</strong>, transforming the album’s themes of <strong>vulnerability, loss, and transformation</strong> into a new visual perspective.</p>

      <h2 className="section-title">Poster Displays</h2>
      <div className="poster-display">
        <img src="/images/billie-mock.jpg" alt="Framed Poster" className="poster-image" />
        <img src="/images/billie-mock.jpg" alt="Outdoor Billboard" className="poster-image" />
      </div>
